...
snow_to_ice = hb.actions.ActionGlacierSnowToIceTransformation(
    "September", 30, "glacier"
)
...
ice_we = results.get_hydro_units_values(component="glacier:ice_content")
...
swe = results.get_hydro_units_values(component="glacier_snowpack:snow_content")
