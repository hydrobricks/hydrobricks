...
def preprocess_glacier_cover_change(debris_covered_glaciers, glacier_shapefile, catchment_shapefile, elevation_thrs, outline_epsg, target_epsg):
    ...
    m2_to_km2 = 1/1000000
    print("The catchment has an area of {0:.1f} km², "
          "from which {1:.1f} km² are glaciated, and " 
          "{2:.1f} km² are bare rock.".format(catchment_area * m2_to_km2, glaciated_area * m2_to_km2, bare_rock_area * m2_to_km2))
    print("The catchment is thus {0:.1f}% glaciated.".format(glaciated_percentage))
    print("The glaciers have {0:.1f} km² of bare ice, "
          "and {1:.1f} km² of debris-covered ice, thus " 
          "amounting to {2:.1f}% of bare ice.".format(bare_ice_area * m2_to_km2, debris_glaciated_area * m2_to_km2, bare_ice_percentage))
    ...
    print("After shapefile to raster conversion, the glaciers have {0:.1f} km² of bare ice, "
          "{1:.1f} km² of debris-covered ice, and {2:.1f} km² of bare rock."
