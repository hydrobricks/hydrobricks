...
/**
 * PREVAH snowpack liquid water release.
 *
 ...
 *   so the store drains to whc x liquid — about (1 - whc) of the liquid water
 *   leaves every melt day. This releases the retained water much faster than
 *   the HBV holding and is reproduced literally here.
 *
 ...
 * With CEXLIQ = 0 (the default) atsliq = 0 and the release is the plain
 * (1 - whc) * C collapse.
 */
