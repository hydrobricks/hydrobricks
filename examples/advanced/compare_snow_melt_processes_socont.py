...
for method in methods:
    ...
    results = spotpy.analyser.load_csv_results(
        f'spotpy_{catchment_name}_{method}'
    )
    ...
    fields = [
        word for word in best_model_run.dtype.names
