...
class ParameterVariable : public Parameter {
  public:
    explicit ParameterVariable(const std::string &name, float value = NAN_F);
...
class ParameterVariableYearly : public ParameterVariable {
  public:
    explicit ParameterVariableYearly(const std::string &name, float value = NAN_F);
...
class ParameterVariableMonthly : public ParameterVariable {
  public:
    explicit ParameterVariableMonthly(const std::string &name, float value = NAN_F);
...
class ParameterVariableDates : public ParameterVariable {
  public:
    explicit ParameterVariableDates(const std::string &name, float value = NAN_F);
